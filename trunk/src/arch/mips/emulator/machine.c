...
void mips_isa_JAL_impl(MIPSContext *ctx)
{
...
void mips_isa_BEQ_impl(MIPSContext *ctx)
{
...
void mips_isa_BNE_impl(MIPSContext *ctx)
{
	if (mips_gpr_get_value(ctx,RS) != mips_gpr_get_value(ctx,RT))
	{
		mips_isa_rel_branch(ctx,SEXT32(IMM << 2, 16));
...
void mips_isa_BLEZ_impl(MIPSContext *ctx)
{
	if ((int)(mips_gpr_get_value(ctx,RS)) <= 0)
		mips_isa_rel_branch(ctx,SEXT32(IMM << 2,16));
		//mips_isa_rel_branch(ctx,IMM << 2);
}
void mips_isa_BGTZ_impl(MIPSContext *ctx)
{
	if ((int)(mips_gpr_get_value(ctx,RS)) > 0)
		mips_isa_rel_branch(ctx,IMM << 2);
}
void mips_isa_ADDI_impl(MIPSContext *ctx)
{
	int temp;
	temp = (int)mips_gpr_get_value(ctx,RS) + (int)(OFFSET);
	mips_gpr_set_value(ctx,RT, temp);
}
void mips_isa_ADDIU_impl(MIPSContext *ctx)
{
...
void mips_isa_SLTI_impl(MIPSContext *ctx)
{
...
void mips_isa_SLTIU_impl(MIPSContext *ctx)
{
...
void mips_isa_ANDI_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RT, mips_gpr_get_value(ctx,RS) & (unsigned int)IMM);
}
void mips_isa_ORI_impl(MIPSContext *ctx)
{
...
void mips_isa_XORI_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RT, mips_gpr_get_value(ctx,RS) ^ (unsigned int) IMM);
}
void mips_isa_LUI_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RT, (int)(IMM << 16));
	mips_isa_inst_debug("  r%d: $0x%x", RT, mips_gpr_get_value(ctx,RT));

}
void mips_isa_BEQL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BNEL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BLEZL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BGTZL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_LB_impl(MIPSContext *ctx)
{
	unsigned char temp;
...
void mips_isa_LH_impl(MIPSContext *ctx)
{
...
void mips_isa_LWL_impl(MIPSContext *ctx)
{
	unsigned char src[4];
...
void mips_isa_LW_impl(MIPSContext *ctx)
{
	unsigned int temp;
...
void mips_isa_LBU_impl(MIPSContext *ctx)
{
	unsigned char temp;
	unsigned int addr = mips_gpr_get_value(ctx,RS) + SEXT32(IMM,16);
	mem_read(ctx->mem, addr, sizeof(unsigned char), &temp);
...
void mips_isa_LHU_impl(MIPSContext *ctx)
{
	unsigned short int temp;
	unsigned int addr = mips_gpr_get_value(ctx,RS) + IMM;
	mem_read(ctx->mem, addr, sizeof(unsigned short int), &temp);
...
void mips_isa_LWR_impl(MIPSContext *ctx)
{
	unsigned char src[4];
	unsigned int rt_value = mips_gpr_get_value(ctx,RT);
	unsigned char *dst = (unsigned char *) & rt_value;
...
void mips_isa_SB_impl(MIPSContext *ctx)
{
...
void mips_isa_SW_impl(MIPSContext *ctx)
{
...
void mips_isa_SWR_impl(MIPSContext *ctx)
{
	unsigned int rt_value = mips_gpr_get_value(ctx,RT);
	unsigned char *src = (unsigned char *) & rt_value;
	unsigned char dst[4];
...
void mips_isa_CACHE_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
...
void mips_isa_LL_impl(MIPSContext *ctx)
{
	unsigned int temp;
...
void mips_isa_LWC1_impl(MIPSContext *ctx)
{
	unsigned int temp;
	float f;
	mem_read(ctx->mem, mips_gpr_get_value(ctx,RS) + IMM, sizeof(unsigned int), &temp);
...
void mips_isa_LWC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_PREF_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_LDC1_impl(MIPSContext *ctx)
{
	unsigned long int temp;
	mem_read(ctx->mem, mips_gpr_get_value(ctx,RS) + IMM, sizeof(unsigned int), &temp);
	MIPS_FPR_D_SET(FT, * (double *) &temp);
}
void mips_isa_LDC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_SC_impl(MIPSContext *ctx)
{      
	unsigned int temp = mips_gpr_get_value(ctx,RT);
	//	if()
...
void mips_isa_SWC1_impl(MIPSContext *ctx)
{
...
void mips_isa_SWC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_SDC1_impl(MIPSContext *ctx)
{
	double dbl = MIPS_FPR_D_GET(FT);
	unsigned long int temp = * (unsigned long int *) &dbl;
	mem_write(ctx->mem, mips_gpr_get_value(ctx,RS) + IMM, sizeof(unsigned int), &temp);
}
void mips_isa_SDC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
...
void mips_isa_SLL_impl(MIPSContext *ctx)
{
...
void mips_isa_MOVF_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVT_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_SRL_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RD, mips_gpr_get_value(ctx,RT) >> SA);
}
...
void mips_isa_SLLV_impl(MIPSContext *ctx)
{
	unsigned int s;
	s = BITS32(mips_gpr_get_value(ctx,RS), 4, 0);
	mips_gpr_set_value(ctx,RD, mips_gpr_get_value(ctx,RT) << s);
}
void mips_isa_SRLV_impl(MIPSContext *ctx)
{
	unsigned int s = BITS32(mips_gpr_get_value(ctx,RS), 4, 0);
	mips_gpr_set_value(ctx,RD, mips_gpr_get_value(ctx,RT) >> s);
}
void mips_isa_ROTRV_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_SRAV_impl(MIPSContext *ctx)
{
	unsigned int s = BITS32(mips_gpr_get_value(ctx,RS), 4, 0);
	mips_gpr_set_value(ctx,RD, (int)mips_gpr_get_value(ctx,RT) >> s);
}
void mips_isa_JR_impl(MIPSContext *ctx)
{
	mips_isa_branch(ctx,mips_gpr_get_value(ctx,RS));
	mips_isa_inst_debug(" target address=0x%x", mips_gpr_get_value(ctx,RS));
}
void mips_isa_JALR_impl(MIPSContext *ctx)
{
	mips_isa_branch(ctx,mips_gpr_get_value(ctx,RS));
	mips_gpr_set_value(ctx,RD, ctx->regs->pc + 8);
	mips_isa_inst_debug("  reg %d = pc + 8 = %x",RD, mips_gpr_get_value(ctx,RD));
}
void mips_isa_MOVZ_impl(MIPSContext *ctx)
{
	if(mips_gpr_get_value(ctx,RT) == 0)
		mips_gpr_set_value(ctx,RD, mips_gpr_get_value(ctx,RS));
}
void mips_isa_MOVN_impl(MIPSContext *ctx)
{
	if(mips_gpr_get_value(ctx,RT) != 0)
		mips_gpr_set_value(ctx,RD, mips_gpr_get_value(ctx,RS));
}
void mips_isa_SYSCALL_impl(MIPSContext *ctx)
{
	MIPSContextSyscall(ctx);
}
void mips_isa_BREAK_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_SYNC_impl(MIPSContext *ctx)
{
	//__MIPS_NOT_IMPL__
}
void mips_isa_MFHI_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RD, MIPS_REG_HI);
}
void mips_isa_MTHI_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MFLO_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RD, MIPS_REG_LO);
}
void mips_isa_MTLO_impl(MIPSContext *ctx)
{
	ctx->regs->regs_LO = mips_gpr_get_value(ctx,RS);
}
void mips_isa_MULT_impl(MIPSContext *ctx)
{
...
void mips_isa_MULTU_impl(MIPSContext *ctx)
{
...
void mips_isa_DIV_impl(MIPSContext *ctx)
{
...
void mips_isa_DIVU_impl(MIPSContext *ctx)
{
	if(mips_gpr_get_value(ctx,RT))
	{
		ctx->regs->regs_LO = mips_gpr_get_value(ctx,RS) /
...
void mips_isa_ADD_impl(MIPSContext *ctx)
{
	int temp = (int)mips_gpr_get_value(ctx,RS) +
				(int)mips_gpr_get_value(ctx,RT);
	mips_gpr_set_value(ctx,RD, temp);
}
void mips_isa_ADDU_impl(MIPSContext *ctx)
{
...
void mips_isa_SUB_impl(MIPSContext *ctx)
{

	__MIPS_NOT_IMPL__
}
void mips_isa_SUBU_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RD, mips_gpr_get_value(ctx,RS) - mips_gpr_get_value(ctx,RT));
}
void mips_isa_AND_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RD, mips_gpr_get_value(ctx,RS) & mips_gpr_get_value(ctx,RT));
}
void mips_isa_OR_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RD, mips_gpr_get_value(ctx,RS) | mips_gpr_get_value(ctx,RT));
}
void mips_isa_XOR_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RD, mips_gpr_get_value(ctx,RS) ^ mips_gpr_get_value(ctx,RT));
}
void mips_isa_NOR_impl(MIPSContext *ctx)
{
	unsigned int temp = mips_gpr_get_value(ctx,RS) | mips_gpr_get_value(ctx,RT);
	mips_gpr_set_value(ctx,RD, ~temp);
}
void mips_isa_SLT_impl(MIPSContext *ctx)
{
...
void mips_isa_SLTU_impl(MIPSContext *ctx)
{
	if (mips_gpr_get_value(ctx,RS) < mips_gpr_get_value(ctx,RT))
		mips_gpr_set_value(ctx,RD, 1);
	else
...
void mips_isa_TGE_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TGEU_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TLT_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TLTU_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TEQ_impl(MIPSContext *ctx)
{
	if ((int)mips_gpr_get_value(ctx,RS) == (int)mips_gpr_get_value(ctx,RT))
	{
...
void mips_isa_TNE_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
...
void mips_isa_BLTZ_impl(MIPSContext *ctx)
{
	if ((int)mips_gpr_get_value(ctx,RS) < 0)
		mips_isa_rel_branch(ctx,IMM << 2);
}
void mips_isa_BGEZ_impl(MIPSContext *ctx)
{
	if ((int)mips_gpr_get_value(ctx,RS) >= 0)
		mips_isa_rel_branch(ctx,SEXT32(IMM << 2,16));
}
void mips_isa_BLTZL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BGEZL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TGEI_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TGEIU_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TLTI_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TLTIU_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TEQI_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TNEI_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BLTZAL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
...
void mips_isa_BLTZALL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BGEZALL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_SYNCI_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
...
void mips_isa_MADD_impl(MIPSContext *ctx)
{/*
...
void mips_isa_MADDU_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MUL_impl(MIPSContext *ctx)
{
	long int temp = (long int) mips_gpr_get_value(ctx,(int)RS) *
					(long int) mips_gpr_get_value(ctx,(int)RT);
	mips_gpr_set_value(ctx,RD, temp);
}
void mips_isa_MSUB_impl(MIPSContext *ctx)
{
	/*	long int temp, temp1, temp2, temp3;
...
void mips_isa_MSUBU_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
...
//void mips_isa_ST(SDBBP_impl(MIPSContext *ctx)
//{
//}
...
void mips_isa_INS_impl(MIPSContext *ctx)
{
	if (SA > RD)
...
void mips_isa_WSBH_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_SEB_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RD, SEXT32(BITS32(mips_gpr_get_value(ctx,RT), 7, 0),16));
}
void mips_isa_SEH_impl(MIPSContext *ctx)
{
	mips_gpr_set_value(ctx,RD, SEXT32((unsigned short int)mips_gpr_get_value(ctx,RT), 16));
}
void mips_isa_RDHWR_impl(MIPSContext *ctx)
{
	if (RD == 29)
	{
...
void mips_isa_MFCO_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MTCO_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_RDPGPR_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_DI_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_EI_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_WRPGPR_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TLBR_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TLBWI_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TLBWR_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TLBP_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_ERET_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_DERET_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_WAIT_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
...
void mips_isa_MFHC1_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MTC1_impl(MIPSContext *ctx)
{
	unsigned int temp = mips_gpr_get_value(ctx,RT);
	float f = * (float *) &temp;
	MIPS_FPR_S_SET(FS, f);
}
void mips_isa_CTC1_impl(MIPSContext *ctx)
{
	unsigned int temp = mips_gpr_get_value(ctx,RT);
	switch(FS)
	{
...
void mips_isa_MTHC1_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BC1F_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BC1FL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BC1T_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BC1TL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_ADD_S_impl(MIPSContext *ctx)
{
	MIPS_FPR_S_SET(FD, MIPS_FPR_S_GET(FS) + MIPS_FPR_S_GET(FT));
}
void mips_isa_SUB_S_impl(MIPSContext *ctx)
{
	MIPS_FPR_S_SET(FD, MIPS_FPR_S_GET(FS) - MIPS_FPR_S_GET(FT));
}
void mips_isa_MUL_S_impl(MIPSContext *ctx)
{
	MIPS_FPR_S_SET(FD, MIPS_FPR_S_GET(FS) * MIPS_FPR_S_GET(FT));
}
void mips_isa_DIV_S_impl(MIPSContext *ctx)
{
	MIPS_FPR_S_SET(FD, MIPS_FPR_S_GET(FS) / MIPS_FPR_S_GET(FT));
}
void mips_isa_SQRT_S_impl(MIPSContext *ctx)
{
	float temp = sqrt(MIPS_FPR_S_GET(FS));
	MIPS_FPR_S_SET(FD, temp);
}
void mips_isa_ABS_S_impl(MIPSContext *ctx)
{
	float temp = MIPS_FPR_S_GET(FS) < 0.0 ? -MIPS_FPR_S_GET(FS) : MIPS_FPR_S_GET(FS);
	MIPS_FPR_S_SET(FD, temp);
}
void mips_isa_MOV_S_impl(MIPSContext *ctx)
{
	MIPS_FPR_S_SET(FD, MIPS_FPR_S_GET(FS));
}
void mips_isa_NEG_S_impl(MIPSContext *ctx)
{
	MIPS_FPR_S_SET(FD, -MIPS_FPR_S_GET(FS));
}
void mips_isa_ROUND_L_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TRUNC_L_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_CEIL_L_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_FLOOR_L_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_ROUND_W_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TRUNC_W_S_impl(MIPSContext *ctx)
{
	float temp = MIPS_FPR_S_GET(FS);
	int itmp = (int) temp;
	MIPS_FPR_S_SET(FD, * (float *) &itmp);
}
void mips_isa_CEIL_W_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_FLOOR_W_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVF_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVT_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVZ_S_impl(MIPSContext *ctx)
{
	if (!mips_gpr_get_value(ctx,RT))
		MIPS_FPR_S_SET(FD, MIPS_FPR_S_GET(FS));
}
void mips_isa_MOVN_S_impl(MIPSContext *ctx)
{
	if (mips_gpr_get_value(ctx,RT))
		MIPS_FPR_S_SET(FD, MIPS_FPR_S_GET(FS));
}
void mips_isa_RECIP_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_RSQRT_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_CVT_D_S_impl(MIPSContext *ctx)
{
	float temp = (float) MIPS_FPR_D_GET(FS);
	MIPS_FPR_S_SET(FD, temp);
}
void mips_isa_CVT_W_S_impl(MIPSContext *ctx)
{
	float temp = (float) MIPS_FPR_S_GET(FS);
	int wrd = * (int *) &temp;
	MIPS_FPR_S_SET(FD, (float) wrd);
}
void mips_isa_CVT_L_S_impl(MIPSContext *ctx)
{
	double temp = MIPS_FPR_D_GET(FS);
	long int dwrd = * (long int *) &temp;
	MIPS_FPR_S_SET(FD, (double)dwrd);
}
void mips_isa_CVT_PS_S_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_ADD_D_impl(MIPSContext *ctx)
{
	MIPS_FPR_D_SET(FD, MIPS_FPR_D_GET(FS) + MIPS_FPR_D_GET(FT));
}
void mips_isa_SUB_D_impl(MIPSContext *ctx)
{
	MIPS_FPR_D_SET(FD, MIPS_FPR_D_GET(FS) - MIPS_FPR_D_GET(FT));
}
void mips_isa_MUL_D_impl(MIPSContext *ctx)
{
	MIPS_FPR_D_SET(FD, MIPS_FPR_D_GET(FS) * MIPS_FPR_D_GET(FT));
}
void mips_isa_DIV_D_impl(MIPSContext *ctx)
{
	MIPS_FPR_D_SET(FD, MIPS_FPR_D_GET(FS) / MIPS_FPR_D_GET(FT));
}
void mips_isa_SQRT_D_impl(MIPSContext *ctx)
{
	double temp = sqrt(MIPS_FPR_D_GET(FS));
	MIPS_FPR_D_SET(FD, temp);
}
void mips_isa_ABS_D_impl(MIPSContext *ctx)
{
	double temp = MIPS_FPR_D_GET(FS) < 0.0 ? -MIPS_FPR_D_GET(FS) : MIPS_FPR_D_GET(FS);
	MIPS_FPR_D_SET(FD, temp);
}
void mips_isa_MOV_D_impl(MIPSContext *ctx)
{
	MIPS_FPR_D_SET(FD, MIPS_FPR_D_GET(FS));
}
void mips_isa_NEG_D_impl(MIPSContext *ctx)
{
	MIPS_FPR_D_SET(FD, -MIPS_FPR_D_GET(FS));
}
void mips_isa_ROUND_L_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TRUNC_L_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_CEIL_L_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_FLOOR_L_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_ROUND_W_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_TRUNC_W_D_impl(MIPSContext *ctx)
{
	double temp = MIPS_FPR_D_GET(FS);
	int itmp = (int) temp;
	MIPS_FPR_D_SET(FD, * (double *) &itmp);
}
void mips_isa_CEIL_W_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_FLOOR_W_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVF_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVT_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVZ_D_impl(MIPSContext *ctx)
{
	if (!mips_gpr_get_value(ctx,RT))
		MIPS_FPR_D_SET(FD, MIPS_FPR_D_GET(FS));
}
void mips_isa_MOVN_D_impl(MIPSContext *ctx)
{
	if (mips_gpr_get_value(ctx,RT))
		MIPS_FPR_D_SET(FD, MIPS_FPR_D_GET(FS));
}
void mips_isa_RECIP_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_RSQRT_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_CVT_S_D_impl(MIPSContext *ctx)
{
	double temp = MIPS_FPR_S_GET(FS);
	MIPS_FPR_D_SET(FD, temp);
}
void mips_isa_CVT_W_D_impl(MIPSContext *ctx)
{
	float temp = MIPS_FPR_S_GET(FS);
	int wrd = * (int *) &temp;
	MIPS_FPR_D_SET(FD, (double) wrd);
}
void mips_isa_CVT_L_D_impl(MIPSContext *ctx)
{
	double temp = MIPS_FPR_D_GET(FS);
	long int dwrd = * (long int *) &temp;
	MIPS_FPR_D_SET(FD, (double) dwrd);
}
void mips_isa_C_F_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_UN_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_EQ_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_UEQ_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_OLT_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_ULT_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_OLE_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_ULE_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_SF_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_NGLE_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_SEQ_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_NGL_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_LT_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_NGE_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_LE_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_C_NGT_D_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_CVT_S_W_impl(MIPSContext *ctx)
{
	int wrd = (int) MIPS_FPR_S_GET(FS);
	float temp = * (float *) &wrd;
	MIPS_FPR_S_SET(FD, temp);
}
void mips_isa_CVT_D_W_impl(MIPSContext *ctx)
{
	int wrd = (int) MIPS_FPR_D_GET(FS);
	float temp = * (float *) &wrd;
	MIPS_FPR_S_SET(FD, temp);
}
void mips_isa_ADD_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_SUB_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MUL_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_ABS_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOV_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_NEG_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVF_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVT_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVZ_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MOVN_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_CVT_S_PU_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_CVT_S_PL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_PLL_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_PLU_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_PUL_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_PUU_PS_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
...
void mips_isa_MFC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_CFC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MFHC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MTC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_CTC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_MTHC2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BC2F_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BC2FL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BC2T_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_BC2TL_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
void mips_isa_COP2_impl(MIPSContext *ctx)
{
	__MIPS_NOT_IMPL__
}
