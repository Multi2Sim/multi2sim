...
char *si_gpu_config_help =
	...
	"the parameters of the Souther Islands model for a detailed (architectural)\n"
	"configuration. This file is passed to Multi2Sim with the '--si-config <file>'\n"
	"option, and should always be used together with option '--si-sim detailed'.\n"
	"\n"
	...
	"  NumStreamCores = <num> (Default = 64)\n"
	"      Number of stream cores in a compute unit. Each work-item\n"
	"      is mapped to a stream core when a vector instruction is executed. Stream cores\n"
	"      are time-multiplexed to cover all work-items in a wavefront.\n"
	"  NumRegisters = <num> (Default = 64K)\n"
	"      Number of vector registers in a SIMD. These registers are shared among all\n"
	"      work-items running in a SIMD. This is one of the factors limiting the\n"
	...
	"      Number of work-items in a wavefront, executing AMD Southern Islands\n"
	"      instructions in a SIMD fashion.\n"
	"\n"
	"Section '[ ComputeUnit ]': parameters for the Compute Units.\n"
	"\n"
	"  NumWavefrontPools = <num> (Default = 4)\n"
	"      Number of wavefront pools and SIMD units per compute unit.\n"
	...
	"      unit in a particular wavefront pool. These are some of the factors limiting\n"
	"      the number of work-groups mapped to a compute unit.\n"
	"  FetchLatency = <cycles> (Default = 1)\n"
	"      Latency of instruction memory in number of cycles.\n"
	"  FetchWidth = <num> (Default = 10)\n"
	...
	"  DecodeWidth = <num> (Default = 5)\n"
	"      Maximum number of instructions decoded per cycle.\n"
	"  DecodeBufferSize = <num> (Default = 10)\n"
	...
	"      Latency of register file access in number of cycles.\n"
	"  ReadBufferSize = <num> (Default = 1)\n"
	"      Size of the buffer holding read instructions.\n"
	"  StreamCoreLatency = <cycles> (Default = 8)\n"
	"      Latency of stream core execution in number of cycles.\n"
	"\n"
	...
	"  ReadBufferSize = <num> (Default = 1)\n"
	"      Size of the buffer holding read instructions.\n"
	"  BranchLatency = <cycles> (Default = 4)\n"
	"      Latency of branch execution in number of cycles.\n"
	"\n"
...
unsigned int si_gpu_num_stream_cores = 64; /* Per CU */
