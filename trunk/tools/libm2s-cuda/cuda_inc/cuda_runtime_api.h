 ...
 * \notefnerr
 *
 * \sa ::cudaStreamCreate, ::cudaStreamCreateWithFlags, ::cudaStreamQuery, ::cudaStreamSynchronize, ::cudaStreamWaitEvent, ::cudaStreamAddCallback, ::cudaStreamDestroy
 */
 ...
 * \notefnerr
 *
 * \sa ::cudaStreamCreate, ::cudaStreamQuery, ::cudaStreamSynchronize, ::cudaStreamWaitEvent, ::cudaStreamAddCallback, ::cudaStreamDestroy
 */
 ...
 * \notefnerr
 *
 * \sa ::cudaStreamCreate, ::cudaStreamCreateWithFlags, ::cudaStreamQuery, ::cudaStreamSynchronize, ::cudaStreamWaitEvent, ::cudaStreamDestroy
 */
 ...
 * <table>
 * <tr><td><b>CUDA array type</b></td>
 * <td><b>Valid extents<br>{(width range in elements), (height range), (depth range)}</b></td></tr>
 * <tr><td>1D</td>
 * <td><small>{ (1,maxTexture1DMipmap), 0, 0 }</small></td></tr>
 * <tr><td>2D</td>
 * <td><small>{ (1,maxTexture2DMipmap[0]), (1,maxTexture2DMipmap[1]), 0 }</small></td></tr>
 * <tr><td>3D</td>
 * <td><small>{ (1,maxTexture3D[0]), (1,maxTexture3D[1]), (1,maxTexture3D[2]) }</small></td></tr>
 * <tr><td>1D Layered</td>
 * <td><small>{ (1,maxTexture1DLayered[0]), 0, (1,maxTexture1DLayered[1]) }</small></td></tr>
 * <tr><td>2D Layered</td>
 * <td><small>{ (1,maxTexture2DLayered[0]), (1,maxTexture2DLayered[1]), (1,maxTexture2DLayered[2]) }</small></td></tr>
 * <tr><td>Cubemap</td>
 * <td><small>{ (1,maxTextureCubemap), (1,maxTextureCubemap), 6 }</small></td></tr>
 * <tr><td>Cubemap Layered</td>
 * <td><small>{ (1,maxTextureCubemapLayered[0]), (1,maxTextureCubemapLayered[0]), (1,maxTextureCubemapLayered[1]) }</small></td></tr>
 * </table>
 *
 ...
 *   is set to zero, the only supported address mode is ::cudaAddressModeClamp.
 *
