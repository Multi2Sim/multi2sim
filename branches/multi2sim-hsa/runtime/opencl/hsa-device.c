...
struct opencl_hsa_device_t *opencl_hsa_device_create(struct opencl_device_t *parent)
{
	...
	/* Initialize */
	device = xcalloc(1, sizeof(struct opencl_hsa_device_t));
	device->type = opencl_runtime_type_hsa;
