...
struct mips_isa_cstack_t *mips_isa_cstack_create(MIPSContext *ctx);
void mips_isa_cstack_push(MIPSContext *ctx, char *str);
char *mips_isa_cstack_pop(MIPSContext *ctx);
