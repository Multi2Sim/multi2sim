...
#define CUDA_DEFINE_CALL(name) \
	static int cuda_func_##name(struct x86_ctx_t *ctx);
#include "cuda.dat"
#undef CUDA_DEFINE_CALL

/* List of CUDA driver functions */
typedef int (*cuda_func_t)(struct x86_ctx_t *ctx);
static cuda_func_t cuda_func_table[cuda_call_count + 1] =
{
	NULL,
...
static int cuda_func_versionCheck(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
...
static int cuda_func_cuCtxCreate(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cuCtxDestroy(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cuModuleGetFunction(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cuModuleLoad(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cuMemAlloc(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cuMemFree(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cuMemGetInfo(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cuMemcpyDtoH(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cuMemcpyHtoD(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cuLaunchKernel(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
...
static int cuda_func_cudaRegisterFunction(struct x86_ctx_t *ctx)
{
	struct x86_regs_t *regs = ctx->regs;
	struct mem_t *mem = ctx->mem;
