...
struct vi_net_widget_t *vi_net_widget_create(struct vi_net_t *net)
{
        ...
        HASH_TABLE_FOR_EACH(net->link_table, link_name, link)
        {
                for (int i = 0; i < list_count(link->sublink_list); i++)
                {
                        ...
                        {
                                subLink->src_x = ((VI_NODE_BOARD_WIDTH/2 + VI_NODE_BOARD_PADDING) +
                                                ( 2 * subLink->src_x) * (VI_NODE_BOARD_PADDING + VI_NODE_BOARD_WIDTH));
                                subLink->src_y = - ALPHA + ((VI_NODE_BOARD_HEIGHT/2 + VI_NODE_BOARD_PADDING) +
                                                ( 2 * subLink->src_y) * (VI_NODE_BOARD_PADDING + VI_NODE_BOARD_HEIGHT));

                                subLink->dst_x = ((VI_NODE_BOARD_WIDTH/2 + VI_NODE_BOARD_PADDING) +
                                                ( 2 * subLink->dst_x) * (VI_NODE_BOARD_PADDING + VI_NODE_BOARD_WIDTH));
                                subLink->dst_y = - ALPHA + ((VI_NODE_BOARD_HEIGHT/2 + VI_NODE_BOARD_PADDING) +
                        ...
                        else if (subLink->src_x == subLink->dst_x)
                        {
                                ...
                                {
                                        subLink->src_x = + ALPHA + ((VI_NODE_BOARD_WIDTH/2 + VI_NODE_BOARD_PADDING) +
                                                        ( 2 * subLink->src_x) * (VI_NODE_BOARD_PADDING + VI_NODE_BOARD_WIDTH));
                                        subLink->src_y = ((VI_NODE_BOARD_HEIGHT/2 + VI_NODE_BOARD_PADDING) +
                                                        ( 2 * subLink->src_y) * (VI_NODE_BOARD_PADDING + VI_NODE_BOARD_HEIGHT));

                                        subLink->dst_x = + ALPHA + ((VI_NODE_BOARD_WIDTH/2 + VI_NODE_BOARD_PADDING) +
                                                        ( 2 * subLink->dst_x) * (VI_NODE_BOARD_PADDING + VI_NODE_BOARD_WIDTH));
                                        subLink->dst_y = ((VI_NODE_BOARD_HEIGHT/2 + VI_NODE_BOARD_PADDING) +
                                                        ( 2 * subLink->dst_y) * (VI_NODE_BOARD_PADDING + VI_NODE_BOARD_HEIGHT));
                                }
