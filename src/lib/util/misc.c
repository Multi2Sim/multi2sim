			...
			union double_si_uint32 *s1_reg)
{
	...
	unsigned int input_s0_lo = (unsigned int)(*input_ptr_s0 >> 
					(unsigned long long)32);
	unsigned int input_s0_hi = (unsigned int)(*input_ptr_s0 << 
					(unsigned long long)32);
	
	unsigned int input_s1_lo = (unsigned int)(*input_ptr_s1 >> 
					(unsigned long long)32);
	unsigned int input_s1_hi = (unsigned int)(*input_ptr_s1 << 
					(unsigned long long)32);
	...
	/* extract sign */
	*sign = (unsigned long long)(*input_ptr_s1 >> 
		(unsigned long long)(DOUBLE_BITS - 1));
	
	/* grab exponent */
	*exp0 = (unsigned long long)(*input_ptr_s1 & 
		(unsigned long long)EXP_MASK);
	*exp0 >>= (unsigned long long)(MANT_WIDTH - 1);

	/* select mantissa */
	*mant = (unsigned long long)(*input_ptr_s1 & 
			...
			unsigned long long *dst)
{
	...
	*dst = (unsigned long long)(((unsigned long long)s0 
					<< (unsigned long long)32) 
