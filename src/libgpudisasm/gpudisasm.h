...
struct fmt_cf_gws_word0_t
{
	...
	unsigned int s : 1;  /* [25] */
	unsigned int vim : 2;  /* val_index_mode [27:26] */
	unsigned int rim : 2;  /* rsrc_index_mode [29:28] */
...
{
	unsigned int pc : 3;  /* pop_count [2:0] */
	unsigned int cf_const : 5;  /* cf_const [7:3] */
	unsigned int cond : 2;  /* [9:8] */
	unsigned int count : 6;  /* [15:10] */
	unsigned int __reserved0 : 4;  /* [19:16] */
	unsigned int vpm : 1;  /* valix_pixel_mode [20] */
	unsigned int eop : 1;  /* end_of_program [21] */
	unsigned int cf_inst : 8;  /* [29:22] */
	unsigned int wqm : 1;  /* whole_quad_mode [30] */
	unsigned int b : 1;  /* barrier [31] */
};
...
struct fmt_cf_alu_word0_t
{
	...
	unsigned int kb0 : 4;  /* kcache_bank0 [25:22] */
	unsigned int kb1 : 4;  /* kcache_bank1 [29:26] */
	unsigned int km0 : 2;  /* kcache_mode0 [31:30] */
};


struct fmt_cf_alu_word1_t
{
	unsigned int km1 : 2;  /* kcache_mode1 [1:0] */
	unsigned int kcache_addr0 : 8;  /* [9:2] */
	unsigned int kcache_addr1 : 8;  /* [17:10] */
	unsigned int count : 7;  /* [24:18] */
	unsigned int ac : 1;  /* alt_const [25] */
	unsigned int cf_inst : 4;  /* [29:26] */
	unsigned int wqm : 1;  /* [30] */
	unsigned int b : 1;  /* [31] */
};
...
struct fmt_cf_alu_word0_ext_t {
	...
	unsigned int kbim0 : 2;  /* kcache_bank_index_mode0 [5:4] */
	unsigned int kbim1 : 2;  /* kcache_bank_index_mode1 [7:6] */
	unsigned int kbim2 : 2;  /* kcache_bank_index_mode2 [9:8] */
	unsigned int kbim3 : 2;  /* kcache_bank_index_mode3 [11:10] */
	unsigned int __reserved1 : 10;  /* [21:12] */
	unsigned int kb2 : 4;  /* kcache_bank2 [25:22] */
	unsigned int kb3 : 4;  /* kcache_bank3 [29:26] */
	unsigned int km2 : 2;  /* kcache_mode2 [31:30] */
};


struct fmt_cf_alu_word1_ext_t {
	unsigned int km3 : 2;  /* kcache_mode3 [1:0] */
...
struct fmt_cf_alloc_export_word0_t {
	...
	unsigned int es : 2;  /* elem_size [31:30] */
};
...
struct fmt_cf_alloc_export_word0_rat_t {
	...
	unsigned int rim : 2;  /* rat_index_mode [12:11] */
	unsigned int type : 2;  /* [14:13] */
	unsigned int rw_gpr : 7;  /* [21:15] */
...
struct fmt_cf_alloc_export_word1_buf_t {
	...
	unsigned int vpm : 1;  /* valid_pixel_mode [20] */
	unsigned int eop : 1;  /* end_of_program [21] */
	unsigned int cf_inst : 8;  /* [29:22] */
	unsigned int m : 1;  /* mark [30] */
	unsigned int b : 1;  /* barrier [31] */
};
...
struct fmt_alu_word0_t
{
	...
	unsigned int s0r : 1;  /* [9] */
	unsigned int s0c : 2;  /* src0_chan [11:10] */
	unsigned int s0n : 1;  /* src0_neg [12] */
	unsigned int src1_sel : 9;  /* [21:13] */
	unsigned int s1r : 1;  /* [22] */
	unsigned int s1c : 2;  /* src1_chan [24:23] */
	unsigned int s1n : 1;  /* src1_neg [25] */
	unsigned int im : 3;  /* index_mode [28:26] */
	unsigned int ps : 2;  /* pred_sel [30:29] */
	unsigned int l : 1;  /* last [31] */
};


struct fmt_alu_word1_op2_t
{
	unsigned int s0a : 1;  /* src0_abs [0] */
	unsigned int s1a : 1;  /* src1_abs [1] */
	unsigned int uem : 1;  /* update_exec_mask [2] */
	unsigned int up : 1;  /* update_pred [3] */
	unsigned int wm : 1;  /* write_mask [4] */
	unsigned int omod : 2;  /* [6:5] */
	unsigned int alu_inst : 11;  /* [17:7] */
	unsigned int bs : 3;  /* bank_swizzle [20:18] */
	unsigned int dst_gpr : 7;  /* [27:21] */
	unsigned int dr : 1;  /* dst_rel [28] */
	unsigned int dc : 2;  /* dst_chan [30:29] */
	unsigned int c : 1;  /* clamp [31] */
};
...
struct fmt_alu_word1_op3_t
{
	...
	unsigned int sr : 1;  /* src2_rel [9] */
	unsigned int s2c : 2;  /* src2_chan [11:10] */
	unsigned int sn : 1;  /* src2_neg [12] */
	unsigned int alu_inst : 5;  /* [17:13] */
	unsigned int bs : 3;  /* bank_swizzle [20:18] */
	unsigned int dst_gpr : 7;  /* [27:21] */
	unsigned int dr : 1;  /* [28] */
	unsigned int dc : 2;  /* [30:29] */
	unsigned int c : 1;  /* clamp [31] */
};
...
enum amd_inst_flags_enum {
	...
	AMD_INST_FLAG_DEC_LOOP_IDX      = 0x0004
};
