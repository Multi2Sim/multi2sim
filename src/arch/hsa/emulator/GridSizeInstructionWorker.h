...
#ifndef ARCH_HSA_EMULATOR_GRIDSIZEINSTRUCTIONWORKER_H
#define ARCH_HSA_EMULATOR_GRIDSIZEINSTRUCTIONWORKER_H
...
#endif  // ARCH_HSA_EMULATOR_GRIDSIZEINSTRUCTIONWORKER_H
