...
union kpl_inst_dword_t
{
	...
	struct kpl_fmt_general0_t general0;
	struct kpl_fmt_general1_t general1;
	struct kpl_fmt_general2_t general2;
};
...
/* Decode instruction 'inst' by reading its field 'dword' and populating
 * its field 'info'. If the instruction bytes represent an invalid instruction,
 * field 'info' is set to NULL. */
