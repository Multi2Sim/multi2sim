...
void Inst::DumpHex(std::ostream &os) const
{
	os << misc::fmt("\n\t/*%04x*/     /*0x%08x%08x*/ \t",
...
void Inst::DumpPredShort(std::ostream &os, int high, int low) const
{
...
void Inst::DumpPredNoat(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
	if (value != 7)
	{
...
void Inst::DumpPred(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
	if (value != 7)
	{
...
void Inst::DumpReg(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
	if (value == 255)
		os << "RZ";
...
void Inst::DumpSpecReg(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
	if (value == 61)
		os << "SR_RegAlloc";
...
void Inst::DumpS(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpF(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpAnd(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
	os << inst_and_map.MapValue(value);
}

void Inst::DumpU8(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
	os << inst_u8_map.MapValue(value);
}

void Inst::DumpX(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpU32(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpHi(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpSat(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpPo(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpUs(std::ostream &os, int high0, int low0, int high1,
		int low1) const
{
...
void Inst::DumpCc(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpE(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpCv(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpLmt(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpU(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpRm(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpKeepRefCount(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
...
void Inst::DumpCc2(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
	os << inst_cc2_map.MapValue(value);
}

void Inst::DumpSRCB(std::ostream &os, int high0, int low0, int high1, int low1,
...
void Inst::DumpOffset(std::ostream &os, int high, int low) const
{
	int value = misc::getBits64(bytes.as_dword, high, low);
	if (value)
		os << misc::fmt(" 0x%x", value);
...
void Inst::DumpTarget(std::ostream &os, int high0, int low0, int high1,
		int low1) const
{
	int value0 = misc::getBits64(bytes.as_dword, high0, low0);
	int value1 = misc::getBits64(bytes.as_dword, high1, low1);
...
void Inst::Dump(std::ostream &os) const
{
	...
	while (*fmt_str)
	{
		...
		else if (comm::Asm::isToken(fmt_str, "offset2", length))
		{
			DumpOffset(os, 34, 23);
		}
		else if (comm::Asm::isToken(fmt_str, "const", length))
		{
			DumpEndConst(os, 45, 42);
		}
		else if (comm::Asm::isToken(fmt_str, "srcC", length))
		{
			DumpReg(os, 49, 42);
		}
		...
		else if (comm::Asm::isToken(fmt_str, "src_spec", length))
		{
			DumpSpecReg(os, 30, 23);
		}
		else if (comm::Asm::isToken(fmt_str, "cc_dst", length))
		{
			DumpCc2(os, 6, 2);
		}
		else if (comm::Asm::isToken(fmt_str, "pred1", length))
		{
			DumpPredShort(os, 7, 5);
		}
		else if (comm::Asm::isToken(fmt_str, "pred2", length))
		{
		...
		else if (comm::Asm::isToken(fmt_str, "rm", length))
		{
			DumpRm(os, 43, 42);
		}
		else if (comm::Asm::isToken(fmt_str, "LMT", length))
		{
			DumpLmt(os, 8, 8);
		}
		...
		else if (comm::Asm::isToken(fmt_str, "us", length))
		{
			DumpUs(os, 56, 56, 51, 51);
		}
		else if (comm::Asm::isToken(fmt_str, "po", length))
		{
			DumpPo(os, 55, 55);
		}
		else if (comm::Asm::isToken(fmt_str, "sat", length))
		{
			DumpSat(os, 53, 53);
		}
		else if (comm::Asm::isToken(fmt_str, "hi", length))
		{
			DumpHi(os, 57, 57);
		}
		else if (comm::Asm::isToken(fmt_str, "u8", length))
		{
			DumpU8(os, 58, 56);
		}
		else if (comm::Asm::isToken(fmt_str, "U32", length))
		{
			DumpU32(os, 51, 51);
		}
		else if (comm::Asm::isToken(fmt_str, "x", length))
		{
			DumpX(os, 46, 46);
		}
		else if (comm::Asm::isToken(fmt_str, "and", length))
		{
			DumpAnd(os, 49, 48);
		}
		else if (comm::Asm::isToken(fmt_str, "f", length))
		{
			DumpF(os, 54, 52);
		}
		else if (comm::Asm::isToken(fmt_str, "s", length))
		{
			DumpS(os, 22, 22);
		}
		else if (comm::Asm::isToken(fmt_str, "u", length))
		{
			DumpU(os, 9, 9);
		}
		else if (comm::Asm::isToken(fmt_str, "srcA", length))
		{
			DumpReg(os, 17, 10);
		}
		else if (comm::Asm::isToken(fmt_str, "dst", length))
		{
			DumpReg(os, 9, 2);
		}
		else if (comm::Asm::isToken(fmt_str, "pred0", length))
		{
			DumpPred(os, 21, 18);
			assert(fmt_str[length] == ' ');
			length++;
		}
		else if (comm::Asm::isToken(fmt_str, "pred", length))
		{
			DumpPred(os, 21, 18);
			assert(fmt_str[length] == ' ');
			length++;
