...
static int KplWarpCompareDivergence(const void *elem1, const void *elem2)
{
...
//static void KplWarpDumpDivergence(KplWarp *self, FILE *f)
//{
//	KplThread *thread;
//	struct elem_t
//	{
...
//	list_sort(list, KplWarpCompareDivergence);
...
{
	KplGrid *grid = thread_block->grid;
	KplEmu *emu = grid->emu;
