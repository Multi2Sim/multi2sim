...
int DPU::width = 1;
int DPU::num_dpu_lanes = 32;
int DPU::dispatch_buffer_size = SM::dispatch_latency;//5;
int DPU::read_buffer_size = 15;//5;
int DPU::read_latency = 15;//5;
int DPU::execute_buffer_size = 15;//5;
int DPU::execute_latency = 15;//5;
int DPU::write_buffer_size = 12;//4;
int DPU::write_latency = 12;//4;
...
void DPU::Dispatch(std::unique_ptr<Uop> uop)
{
