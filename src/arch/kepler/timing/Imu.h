...
#ifndef ARCH_KEPLER_TIMING_IMU_H
#define ARCH_KEPLER_TIMING_IMU_H
...
class IMU : public ExecutionUnit
{
...
public:
	...
	/// Constructor
	IMU(int id, SM *sm) : ExecutionUnit(sm), id(id)
	{
	}
	...
	/// Dispatch the given instruction into the IMU
