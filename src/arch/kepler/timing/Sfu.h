...
#ifndef ARCH_KEPLER_TIMING_SFU_H
#define ARCH_KEPLER_TIMING_SFU_H
...
class SFU : public ExecutionUnit
{
	...
	// Variable number of write instructions
...
public:
	...
	/// Constructor
	SFU(int id, SM *sm) : ExecutionUnit(sm), id(id)
	{
	}
	...
	/// Dispatch the given instruction into the SFU
