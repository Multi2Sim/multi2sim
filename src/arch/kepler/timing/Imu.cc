...
int IMU::width = 1;
int IMU::num_imu_lanes = 32;
int IMU::dispatch_buffer_size = SM::dispatch_latency;
int IMU::read_latency = 1;//5;
int IMU::read_buffer_size = read_latency;
int IMU::execute_latency = 1;//5;
int IMU::execute_buffer_size = execute_latency;
int IMU::write_latency = 1;//4;
int IMU::write_buffer_size = write_latency;
...
void IMU::Dispatch(std::unique_ptr<Uop> uop)
{
	// One more instruction of this kind
	SM *sm = getSM();

	// One more instructions of this kind
