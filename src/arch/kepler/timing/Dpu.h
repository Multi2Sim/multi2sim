...
#ifndef ARCH_KEPLER_TIMING_DPU_H
#define ARCH_KEPLER_TIMING_DPU_H
...
class DPU : public ExecutionUnit
{
...
public:
	...
	/// Constructor
	DPU(int id, SM *sm) : ExecutionUnit(sm), id(id)
	{
	}
	...
	/// Dispatch the given instruction into the DPU
