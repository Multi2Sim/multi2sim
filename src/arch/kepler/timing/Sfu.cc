...
int SFU::width = 1;
int SFU::num_sfu_lanes = 32;
int SFU::dispatch_buffer_size = SM::dispatch_latency;
int SFU::read_latency = 1;//5;
int SFU::read_buffer_size = read_latency;
int SFU::execute_latency = 1;//5;
int SFU::execute_buffer_size = execute_latency;
int SFU::write_latency = 1;//4;
int SFU::write_buffer_size = write_latency;
...
void SFU::Dispatch(std::unique_ptr<Uop> uop)
{
	// Get SM
	SM *sm = getSM();
