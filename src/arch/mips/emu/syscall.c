...
static struct str_map_t mips_sys_error_code_map =
{
	34,
	{
		{ "EPERM", 1 },
...
static struct str_map_t mips_sys_open_flags_map =
{
	16, {
		{ "O_RDONLY",        00000000 },
		{ "O_WRONLY",        00000001 },
...
static void mips_sys_stat_host_to_guest(struct sim_stat64_t *guest, struct stat *host)
{
