...
void Instruction::Decode(unsigned addr, const char *buf)
{
	Info *current_table;
...
void Instruction::DumpSa(std::ostream &os) const
{
	unsigned sa;
...
void Instruction::DumpRd(std::ostream &os) const
{
	unsigned rd;
	int token_len;
...
void Instruction::DumpRt(std::ostream &os) const
{
...
void Instruction::DumpRs(std::ostream &os) const
{
...
void Instruction::DumpTarget(std::ostream &os)
{
...
void Instruction::DumpOffset(std::ostream &os) const
{
...
void Instruction::DumpOffsetbr(std::ostream &os)
{
	int offsetbr = misc::SignExtend32(bytes.cc.offsetbr, 16);
	offsetbr = (offsetbr << 2) + address + 4;
	target = offsetbr;
	os << misc::fmt("%x", offsetbr);
}


void Instruction::DumpImm(std::ostream &os) const
{
...
void Instruction::DumpImmhex(std::ostream &os) const
{
...
void Instruction::DumpBase(std::ostream &os) const
{
...
void Instruction::DumpSel(std::ostream &os) const
{
...
void Instruction::DumpCc(std::ostream &os) const
{
...
void Instruction::DumpPos(std::ostream &os) const
{
...
void Instruction::DumpFs(std::ostream &os) const
{
...
void Instruction::DumpSize(std::ostream &os) const
{
	unsigned pos = bytes.standard.sa;
...
void Instruction::DumpFt(std::ostream &os) const
{
...
void Instruction::DumpFd(std::ostream &os) const
{
...
void Instruction::DumpCode(std::ostream &os) const
{
...
void Instruction::DumpHint(std::ostream &os) const
{
...
void Instruction::DumpHex(std::ostream &os)
{
	os << misc::fmt("\n%8x:\t%08x \t", address, bytes.word);
}
