...
#ifndef TOOLS_CLCC_CL2LLVM_WHILD_BLOCK_H
#define TOOLS_CLCC_CL2LLVM_WHILE_BLOCK_H

#include <llvm-c/Core.h>

struct cl2llvm_while_blocks_t
{
	LLVMBasicBlockRef while_cond;
	LLVMBasicBlockRef while_stmt;
